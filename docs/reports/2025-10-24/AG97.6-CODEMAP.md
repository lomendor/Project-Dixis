...
### frontend/tests/e2e/orders-facets-aggregation.pg-e2e.spec.ts
- **Origin**: `frontend/tests/pg-e2e/orders-facets-aggregation.spec.ts` (AG97.3)
- **Destination**: `frontend/tests/e2e/orders-facets-aggregation.pg-e2e.spec.ts`
- **Reason**: Playwright config has `testDir: './tests/e2e'`, must be inside that directory for discovery
...
- **New**: `pnpm exec playwright test tests/e2e/orders-facets-aggregation.pg-e2e.spec.ts --reporter=line`
