...
test.describe("Auth UX Improvements", () => {
    ...
    test.skip("should show validation error toasts on register form", async ({
        page,
    }) => {
        const helper = new AuthE2EHelper(page);
    ...
    test("should redirect producer to dashboard after login", async ({
        page,
    }) => {
        const helper = new AuthE2EHelper(page);
    ...
    test.skip("should clear intended destination after successful redirect", async ({
        page,
    }) => {
        const helper = new AuthE2EHelper(page);
