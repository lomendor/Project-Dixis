...
const sections: { title: string; items: FaqItem[] }[] = [
    ...
    items: [
      {
        ...
        a: 'Επιλέξτε τα προϊόντα που θέλετε, προσθέστε τα στο καλάθι σας και προχωρήστε στο ταμείο. Η πληρωμή γίνεται με κάρτα μέσω Stripe.',
      },
      {
        q: 'Ποιοι είναι οι τρόποι πληρωμής;',
        a: 'Δεχόμαστε πιστωτικές/χρεωστικές κάρτες μέσω Stripe.',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: 'Πώς εξασφαλίζεται η ποιότητα;',
        a: 'Τα προϊόντα μας προέρχονται απευθείας από επιλεγμένους Έλληνες παραγωγούς και αποστέλλονται κατά παραγγελία με αυστηρά κριτήρια ποιότητας.',
      },
      {
