  ...
  return (
    <main className="min-h-screen bg-neutral-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        {list.length === 0 ? (
          <div
            className="bg-white border rounded-xl p-10 sm:p-14 text-center"
          ...
          >
            ...
            <p className="text-sm text-neutral-500 mb-6">
              Ανακαλύψτε τα αυθεντικά ελληνικά προϊόντα μας!
            </p>
            <Link
              href="/products"
          ...
          <>
            ...
            {isMultiProducerCart(items) && (
              <div
                className="flex items-start gap-2 rounded-lg bg-amber-50 border border-amber-200 p-3 text-sm mb-4"
                data-testid="multi-producer-notice"
              >
                <svg
                ...
                <p className="text-amber-800">
                  Το καλάθι σας περιέχει προϊόντα από διαφορετικούς παραγωγούς.
                  Θα λάβετε <strong>ξεχωριστά δέματα</strong> για κάθε παραγωγό.
                </p>
              </div>
            )}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-white border rounded-xl divide-y">
                {list.map(it => (
                  <div
                    key={it.id}
                    className="p-4 flex gap-4 items-start justify-between overflow-visible"
                  >
                    <div className="flex gap-4 items-center flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm text-neutral-500">
                          {fmt.format(it.priceCents / 100)}
                        </div>
                        <div className="mt-2 flex items-center gap-3 flex-wrap">
                          <button
                            type="button"
                            onClick={() => dec(it.id)}
                            className="h-12 w-12 rounded border hover:bg-neutral-50 flex items-center justify-center text-lg"
                    ...
                    <div
                      className="shrink-0 text-right font-semibold text-lg whitespace-nowrap ml-4 mt-1"
              ...
              <aside className="bg-white border rounded-xl p-6 h-fit">
                ...
                <p className="text-xs text-neutral-500 mt-2">
                  Οι τελικές χρεώσεις (μεταφορικά/ΦΠΑ) υπολογίζονται κατά την
                  ολοκλήρωση.
                </p>
                <button
                ...
                <Link
                  href="/products"
                  className="mt-2 w-full inline-flex justify-center border border-neutral-300 text-neutral-700 px-4 py-2 rounded-lg hover:bg-neutral-50"
                >
                  Συνέχεια αγορών
                </Link>
              </aside>
