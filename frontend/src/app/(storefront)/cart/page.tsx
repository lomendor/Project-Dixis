                  ...
                  <div className="flex gap-4 items-center flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 flex items-center gap-3 flex-wrap">
                        <button type="button" onClick={() => dec(it.id)} className="h-12 w-12 rounded border hover:bg-neutral-50 flex items-center justify-center text-lg" data-testid="qty-minus">−</button>
                        <span className="min-w-8 text-center" data-testid="qty">{it.qty}</span>
                        <button type="button" onClick={() => inc(it.id)} className="h-12 w-12 rounded border hover:bg-neutral-50 flex items-center justify-center text-lg" data-testid="qty-plus">+</button>
                      </div>
                    </div>
                  </div>
