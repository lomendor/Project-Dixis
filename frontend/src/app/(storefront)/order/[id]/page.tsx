...
import { StatusChip } from '@/components/order/StatusChips';
...
export default async function OrderConfirmationPage({ params }: Props) {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{ marginBottom: 24 }} data-testid="order-summary">
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <span data-testid="order-shipping">€0.00</span>
        </div>
        <div style={{
          display: 'flex',
          ...
          <span>Σύνολο:</span>
          <span data-testid="order-total">€{Number(order.total).toFixed(2)}</span>
        </div>
      </div>
