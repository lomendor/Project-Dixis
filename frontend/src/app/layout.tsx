...
export const metadata: Metadata = {
  ...
  title: {
    default: "Dixis — Ελληνικά Προϊόντα από Παραγωγούς",
    template: "%s | Dixis"
  },
  description: "Αυθεντικά ελληνικά προϊόντα απευθείας από παραγωγούς. Ελαιόλαδο, μέλι, βότανα, όσπρια — από τον παραγωγό στην πόρτα σας.",
  keywords: [
    "τοπικοί παραγωγοί",
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: 'Dixis',
    title: 'Dixis — Ελληνικά Προϊόντα από Παραγωγούς',
    description: 'Αυθεντικά ελληνικά προϊόντα απευθείας από παραγωγούς. Από τον παραγωγό στην πόρτα σας.',
    // OG image auto-generated by src/app/opengraph-image.tsx (1200x630 branded)
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                'https://gr.linkedin.com/company/dixis-company',
