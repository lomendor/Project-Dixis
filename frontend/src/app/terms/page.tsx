      ...
      <div className="prose prose-gray max-w-none space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <li>Αποδεκτοί τρόποι πληρωμής: Πιστωτική/χρεωστική κάρτα μέσω Stripe, αντικαταβολή</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <li>Δωρεάν αποστολή για παραγγελίες άνω των 35 € ανά παραγωγό</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <li>Λόγω φύσης (τρόφιμα), ορισμένα προϊόντα εξαιρούνται από επιστροφή</li>
