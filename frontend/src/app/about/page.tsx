...
const values = [
  {
    ...
    description:
      'Κάθε προϊόν ταξιδεύει απευθείας από το χωράφι στο τραπέζι σας, χωρίς μεσάζοντες. Αυτό σημαίνει φρεσκάδα, ποιότητα και δίκαιη τιμή.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-700 leading-relaxed">
                Εμείς αλλάζουμε αυτό. Στο Dixis, κάθε αγορά γίνεται απευθείας: από το χωράφι,
                τον ελαιώνα ή το τυροκομείο, κατευθείαν στην πόρτα σας. Χωρίς ενδιάμεσους,
