...
export const metadata: Metadata = {
  ...
  description:
    'Η Dixis συνδέει Έλληνες μικροπαραγωγούς απευθείας με καταναλωτές — με ελάχιστη προμήθεια, πλήρη διαφάνεια και σεβασμό στην ποιότητα.',
}
...
const values = [
  {
    ...
    description:
      'Κάθε προϊόν ταξιδεύει απευθείας από τον παραγωγό στην πόρτα σας, χωρίς εμπόρους ή χονδρέμπορους. Αυτό σημαίνει αυθεντικότητα, φρεσκάδα και δίκαιη τιμή.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Ξέρετε ακριβώς πού πάει κάθε ευρώ. Μόνο 12% προμήθεια πλατφόρμας — χαμηλή και διαφανής. Το μεταφορικό και η πληρωμή αναλύονται ξεχωριστά στο checkout.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const stats = [
  ...
  { value: '12%', label: 'Προμήθεια Πλατφόρμας' },
  { value: 'Απευθείας', label: 'Από Παραγωγό σε Εσάς' },
]
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-700 leading-relaxed">
                ...
                το μελισσοκομείο ή το εργαστήριο, κατευθείαν στην πόρτα σας. Χωρίς εμπόρους,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Ανακαλύψτε, συγκρίνετε και παραγγείλτε ποιοτικά τρόφιμα με ασφαλή πληρωμή μέσω κάρτας.',
              },
              {
                step: '03',
