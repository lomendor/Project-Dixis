  ...
  const renderStatusBanner = () => {
    ...
    const statusConfig = {
      pending: {
        ...
        icon: '⏳',
        title: 'Αναμένεται Έγκριση',
        message: 'Η αίτησή σας έχει υποβληθεί και βρίσκεται υπό εξέταση. Θα ενημερωθείτε με email όταν ολοκληρωθεί η διαδικασία.'
      },
      active: {
        className: 'bg-green-50 border-green-200 text-green-800',
        icon: '✅',
        title: 'Εγκεκριμένος Παραγωγός',
        message: 'Συγχαρητήρια! Η αίτησή σας έχει εγκριθεί και μπορείτε τώρα να διαχειρίζεστε τα προϊόντα σας.'
      },
      inactive: {
        className: 'bg-red-50 border-red-200 text-red-800',
        icon: '❌',
        title: 'Αίτηση Απορρίφθηκε',
        message: 'Δυστυχώς η αίτησή σας δεν μπορεί να εγκριθεί αυτή τη στιγμή. Επικοινωνήστε μαζί μας για περισσότερες πληροφορίες.'
      }
    };
