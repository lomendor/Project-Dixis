...
export default async function ProducerSpotlight() {
  ...
  if (!producer) {
    return (
      <section className="py-16 sm:py-20 bg-neutral-50">
        <div className="max-w-[1800px] mx-auto px-5 sm:px-8 lg:px-12 text-center">
  ...
  return (
    <section className="bg-neutral-50">
      <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[400px] lg:min-h-[500px]">
