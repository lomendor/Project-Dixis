    ...
    <section className="bg-gradient-to-br from-accent-cream to-accent-beige py-12 sm:py-16 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed mb-8 sm:text-xl sm:mb-10 max-w-2xl mx-auto">
          Ανακαλύψτε αυθεντικά, παραδοσιακά προϊόντα από Έλληνες παραγωγούς.
          Υποστηρίξτε την τοπική οικονομία και απολαύστε την πραγματική γεύση της Ελλάδας.
        </p>
        ...
        <div className="mt-10 pt-8 border-t border-accent-gold/20">
          <div className="flex flex-wrap justify-center gap-6 text-sm text-neutral-600">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Γρήγορη αποστολή σε όλη την Ελλάδα</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-accent-gold" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
