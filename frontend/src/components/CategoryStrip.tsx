...
export function CategoryStrip({
  ...
  const iconBoxClass =
    'w-[88px] h-[88px] sm:w-[96px] sm:h-[96px] lg:w-[76px] lg:h-[76px]';
  const imgClass =
    'w-[76px] h-[76px] sm:w-[84px] sm:h-[84px] lg:w-[64px] lg:h-[64px] object-contain';
  const colClass =
    'flex flex-col items-center gap-1.5 w-[104px] sm:w-[112px] lg:w-[100px] shrink-0 lg:shrink group';
