...
export function ProductCard({ id, title, producer, priceCents, image }: Props) {
  ...
  return (
    <div className="group flex flex-col h-full bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300">
      ...
      <div className="flex flex-col flex-grow p-4">
        <div className="mb-2">
          ...
          <h3 className="text-base font-bold text-gray-900 line-clamp-2 mt-1 leading-tight">
            {title}
          </h3>
        </div>
...
export function ProductCardSkeleton() {
  return (
    <div className="flex flex-col h-full bg-white border border-gray-200 rounded-xl overflow-hidden animate-pulse">
