...
/**
 * Pass PRICE-TRANSPARENCY-01: Price breakdown component for producer product forms.
 *
 * Shows the producer exactly how their selling price breaks down:
 * - Selling price (what the customer pays)
 * - Dixis commission (default 12%)
 * - Stripe processing fee (~1.5% + €0.25 for EU cards)
 * - Net amount (what the producer receives)
 *
...
export default function PriceBreakdown({ price, discountPrice }: PriceBreakdownProps) {
    ...
    <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4" data-testid="price-breakdown">
      ...
      <div className="space-y-1.5 text-sm">
        ...
        <div className="flex justify-between">
          <span className="text-gray-600">Τιμή πώλησης</span>
        ...
        {/* Net amount - what producer receives */}
